...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Comic+Neue:wght@300;400;700&family=Fredoka+One&display=swap" 
    ...
    <div class="absolute inset-0 overflow-hidden">
        <div class="absolute top-10 left-10 text-white opacity-20 float" style="animation-delay: 0s;">
            <svg class="w-24 h-24" fill="currentColor" viewBox="0 0 24 24">
                <path d="M19.35 10.04C18.67 6.59 15.64 4 12 4 9.11 4 6.6 5.64 
                5.35 8.04 2.34 8.36 0 10.91 0 14c0 3.31 2.69 6 6 6h13c2.76 0 5-2.24 5-5 0-2.64-2.05-4.78-4.65-4.96z"/>
            </svg>
        </div>
        ...
        <div class="absolute bottom-32 right-32 text-red-400 opacity-30 bounce" style="animation-delay: 1.5s;">
            <svg class="w-16 h-16" fill="currentColor" viewBox="0 0 24 24">
                <path d="M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zM20.71
                 7.04c.39-.39.39-1.02 0-1.41l-2.34-2.34c-.39-.39-1.02-.39-1.41 0l-1.83 1.83 3.75 3.75 1.83-1.83z"/>
            </svg>
        </div>
    </div>
    ...
    <div class="max-w-6xl w-full grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
        ...
        <div class="login-card p-8 lg:p-10 relative">
            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-6">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input id="email" 
                               ...
                               autocomplete="email"
                               value="{{ old('email') }}"
                               class="block w-full pl-12 pr-4 py-4 border-2
                                border-gray-300 rounded-2xl focus:ring-4 focus:ring-yellow-200 focus:border-yellow-400 transition duration-200 text-lg"
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input id="password" 
                               ...
                               class="block w-full pl-12 pr-4 py-4 border-2 border-gray-300 rounded-2xl
                                focus:ring-4 focus:ring-yellow-200 focus:border-yellow-400 transition duration-200 text-lg"
                               placeholder="••••••••">
                    </div>
                    @error('password')
                        <p class="mt-2 text-sm text-red-600 flex items-center">
                ...
                <button type="submit" 
                        class="w-full bg-gradient-to-r from-yellow-400 to-orange-400 text-white py-4 px-6
                         rounded-2xl font-bold text-xl shadow-lg hover:shadow-xl transform hover:scale-105 transition duration-200 focus:outline-none focus:ring-4 focus:ring-yellow-200">
